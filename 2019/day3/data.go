...
func (e InputData) wire1Moves() []Move {
	wire1 := strings.Split(
	...
	// 	"R8,U5,L5,D3",
	// 	",")
	return convertWire2Moves(wire1)
}

func (e InputData) wire2Moves() []Move {
	wire2 := strings.Split(
	...
	// 	"U7,R6,D4,L4",
	// 	",")
	return convertWire2Moves(wire2)
}

func convertWire2Moves(wire []string) []Move {
	wireMoves := []Move{}
	for i := 0; i < len(wire); i++ {
		...
		distance, _ := strconv.ParseInt(wire[i][1:], 10, 0)
		wireMoves = append(wireMoves, Move{direction, int(distance)})
	}
	return wireMoves
}
